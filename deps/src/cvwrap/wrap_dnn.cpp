...
define_dnn_module(Module &mod) {
  mod.add_type<cv::dnn::experimental_dnn_34_v7::DictValue>("DictValue")
      .constructor<const cv::dnn::experimental_dnn_34_v7::DictValue &>()
      .constructor<int64>()
      .constructor<int>()
      ...
      .method("size",
              [](const cv::dnn::experimental_dnn_34_v7::DictValue &instance) {
      ...
      .method("operator=",
              [](cv::dnn::experimental_dnn_34_v7::DictValue &instance,
                 const cv::dnn::experimental_dnn_34_v7::DictValue &r) {
                return instance.operator=(r);
              });
  mod.add_type<cv::dnn::experimental_dnn_34_v7::Dict>("Dict")
      .method("has", [](const cv::dnn::experimental_dnn_34_v7::Dict &instance,
                        const cv::String &key) { return instance.has(key); })
      .method("ptr", [](cv::dnn::experimental_dnn_34_v7::Dict &instance,
                        const cv::String &key) { return instance.ptr(key); })
      .method("ptr", [](const cv::dnn::experimental_dnn_34_v7::Dict &instance,
                        const cv::String &key) { return instance.ptr(key); })
      .method("get", [](const cv::dnn::experimental_dnn_34_v7::Dict &instance,
                        const cv::String &key) { return instance.get(key); })
      .method("begin",
              [](const cv::dnn::experimental_dnn_34_v7::Dict &instance) {
                return instance.begin();
              })
      .method("end", [](const cv::dnn::experimental_dnn_34_v7::Dict &instance) {
        return instance.end();
      });
  mod.add_bits<cv::dnn::experimental_dnn_34_v7::Backend>("Backend");
  mod.set_const("DNN_BACKEND_DEFAULT",
                cv::dnn::experimental_dnn_34_v7::Backend::DNN_BACKEND_DEFAULT);
  mod.set_const("DNN_BACKEND_HALIDE",
                cv::dnn::experimental_dnn_34_v7::Backend::DNN_BACKEND_HALIDE);
  mod.set_const(
      "DNN_BACKEND_INFERENCE_ENGINE",
      cv::dnn::experimental_dnn_34_v7::Backend::DNN_BACKEND_INFERENCE_ENGINE);
  mod.set_const("DNN_BACKEND_OPENCV",
                cv::dnn::experimental_dnn_34_v7::Backend::DNN_BACKEND_OPENCV);
  mod.add_bits<cv::dnn::experimental_dnn_34_v7::Target>("Target");
  mod.set_const("DNN_TARGET_CPU",
                cv::dnn::experimental_dnn_34_v7::Target::DNN_TARGET_CPU);
  mod.set_const("DNN_TARGET_OPENCL",
                cv::dnn::experimental_dnn_34_v7::Target::DNN_TARGET_OPENCL);
  mod.set_const("DNN_TARGET_OPENCL_FP16",
                cv::dnn::experimental_dnn_34_v7::Target::DNN_TARGET_OPENCL_FP16);
  mod.set_const("DNN_TARGET_MYRIAD",
                cv::dnn::experimental_dnn_34_v7::Target::DNN_TARGET_MYRIAD);
  mod.add_type<cv::dnn::experimental_dnn_34_v7::LayerParams>("LayerParams")
      .method("blobs",
              [](const cv::dnn::experimental_dnn_34_v7::LayerParams &instance) {
  ...
  /*mod.add_type<cv::dnn::experimental_dnn_34_v7::BackendNode>("BackendNode")
      .constructor<int>()
      .method("backendId",
              [](const cv::dnn::experimental_dnn_34_v7::BackendNode &instance) {
                return instance.backendId;
              });*/
  /*mod.add_type<cv::dnn::experimental_dnn_34_v7::BackendWrapper>(
     "BackendWrapper")
//.constructor<int, int>()
//.constructor<int, const cv::Mat &>()
//.constructor<const Ptr<cv::dnn::experimental_dnn_34_v7::BackendWrapper> &,
//             const cv::dnn::experimental_dnn_34_v7::MatShape &>()
.method("copyToHost",
[](cv::dnn::experimental_dnn_34_v7::BackendWrapper &instance) {
...
.method("backendId",
[](const cv::dnn::experimental_dnn_34_v7::BackendWrapper &instance) {
return instance.backendId;
})
.method("targetId",
[](const cv::dnn::experimental_dnn_34_v7::BackendWrapper &instance) {
return instance.targetId;
  ...
  mod.add_type<cv::dnn::experimental_dnn_34_v7::Layer>("Layer")
      .method("blobs",
              [](const cv::dnn::experimental_dnn_34_v7::Layer &instance) {
                return instance.blobs;
              })
      /*.method(
          "finalize",
          [](cv::dnn::experimental_dnn_34_v7::Layer &instance,
      ...
      //.method("finalize",[](cv::dnn::experimental_dnn_34_v7::Layer &instance) {
      ...
      .method("supportBackend",
              [](cv::dnn::experimental_dnn_34_v7::Layer &instance, int backendId) {
      ...
      /*.method(
          ...
          [](cv::dnn::experimental_dnn_34_v7::Layer &instance,
             const std::vector<
                 Ptr<cv::dnn::experimental_dnn_34_v7::BackendWrapper> > &inputs) {
      ...
      .method("applyHalideScheduler",
              [](const cv::dnn::experimental_dnn_34_v7::Layer &instance,
                 cv::Ptr<cv::dnn::experimental_dnn_34_v7::BackendNode> &node,
      ...
      .method(
          "tryAttach",
          [](cv::dnn::experimental_dnn_34_v7::Layer &instance,
             const cv::Ptr<cv::dnn::experimental_dnn_34_v7::BackendNode> &node) {
            return instance.tryAttach(node);
          })*/
      /*.method("setActivation",
              [](cv::dnn::experimental_dnn_34_v7::Layer &instance,
                 const cv::Ptr<cv::dnn::experimental_dnn_34_v7::ActivationLayer>
                     &layer) { return instance.setActivation(layer); })*/
      .method("tryFuse",
              [](cv::dnn::experimental_dnn_34_v7::Layer &instance,
                 cv::Ptr<cv::dnn::experimental_dnn_34_v7::Layer> &top) {
      ...
      .method(
          "getMemoryShapes",
          [](const cv::dnn::experimental_dnn_34_v7::Layer &instance,
             const std::vector<cv::dnn::experimental_dnn_34_v7::MatShape> &inputs,
             const int requiredOutputs,
             const std::vector<cv::dnn::experimental_dnn_34_v7::MatShape> &outputs,
             const std::vector<cv::dnn::experimental_dnn_34_v7::MatShape>
                 &internals) {
  ...
  mod.add_type<cv::dnn::experimental_dnn_34_v7::Net>("Net")
      ...
      .method("getLayer",
              [](cv::dnn::experimental_dnn_34_v7::Net &instance,
                 cv::dnn::experimental_dnn_34_v7::Net::LayerId layerId) {
      ...
      .method("deleteLayer",
              [](cv::dnn::experimental_dnn_34_v7::Net &instance,
                 cv::dnn::experimental_dnn_34_v7::Net::LayerId layer) {
                return instance.deleteLayer(layer);
              })
      .method(
          "connect",
          [](cv::dnn::experimental_dnn_34_v7::Net &instance, cv::String outPin,
             cv::String inpPin) { return instance.connect(outPin, inpPin); })
      .method("connect",
              [](cv::dnn::experimental_dnn_34_v7::Net &instance, int outLayerId,
      ...
      .method("setPreferableBackend",
              [](cv::dnn::experimental_dnn_34_v7::Net &instance, int backendId) {
                return instance.setPreferableBackend(backendId);
              })
      .method("setPreferableTarget",
              [](cv::dnn::experimental_dnn_34_v7::Net &instance, int targetId) {
                return instance.setPreferableTarget(targetId);
              })
      .method(
          "setInput",
          [](cv::dnn::experimental_dnn_34_v7::Net &instance, const cv::Mat &blob) {
      ...
      .method("setParam",
              [](cv::dnn::experimental_dnn_34_v7::Net &instance,
                 cv::dnn::experimental_dnn_34_v7::Net::LayerId layer, int numParam,
                 const cv::Mat &blob) {
      ...
      .method("getLayersShapes",
              [](const cv::dnn::experimental_dnn_34_v7::Net &instance,
                 ...
                 const std::vector<std::vector<
                     cv::dnn::experimental_dnn_34_v7::MatShape> > &inLayersShapes,
                 const std::vector<
                     std::vector<cv::dnn::experimental_dnn_34_v7::MatShape> >
                     &outLayersShapes) {
      ...
      .method("getLayersShapes",
              [](const cv::dnn::experimental_dnn_34_v7::Net &instance,
                 const cv::dnn::experimental_dnn_34_v7::MatShape &netInputShape,
                 const std::vector<int> &layersIds,
                 const std::vector<std::vector<
                     cv::dnn::experimental_dnn_34_v7::MatShape> > &inLayersShapes,
                 const std::vector<
      ...
      .method("enableFusion",
              [](cv::dnn::experimental_dnn_34_v7::Net &instance, bool fusion) {
                return instance.enableFusion(fusion);
              })
      .method("getPerfProfile", [](cv::dnn::experimental_dnn_34_v7::Net &instance,
  ...
  mod.method("readNetFromDarknet", [](const cv::String &cfgFile) {
    return cv::dnn::experimental_dnn_34_v7::readNetFromDarknet(cfgFile);
  });
  mod.method("readNetFromDarknet",
             [](const cv::String &cfgFile, const cv::String &darknetModel) {
               return cv::dnn::experimental_dnn_34_v7::readNetFromDarknet(
                   cfgFile, darknetModel);
             });
  mod.method("readNetFromCaffe", [](const cv::String &prototxt) {
    return cv::dnn::experimental_dnn_34_v7::readNetFromCaffe(prototxt);
  });
  mod.method("readNetFromCaffe", [](const cv::String &prototxt,
                                    const cv::String &caffeModel) {
    return cv::dnn::experimental_dnn_34_v7::readNetFromCaffe(prototxt, caffeModel);
  });
  mod.method("readNetFromCaffe", [](const char *bufferProto, size_t lenProto) {
    return cv::dnn::experimental_dnn_34_v7::readNetFromCaffe(bufferProto,
                                                          lenProto);
  });
  mod.method("readNetFromCaffe", [](const char *bufferProto, size_t lenProto,
                                    const char *bufferModel) {
    return cv::dnn::experimental_dnn_34_v7::readNetFromCaffe(bufferProto, lenProto,
                                                          bufferModel);
  });
  mod.method("readNetFromCaffe", [](const char *bufferProto, size_t lenProto,
                                    const char *bufferModel, size_t lenModel) {
    return cv::dnn::experimental_dnn_34_v7::readNetFromCaffe(
        bufferProto, lenProto, bufferModel, lenModel);
  });
  mod.method("readNetFromTensorflow", [](const cv::String &model) {
    return cv::dnn::experimental_dnn_34_v7::readNetFromTensorflow(model);
  });
  mod.method("readNetFromTensorflow", [](const cv::String &model,
                                         const cv::String &config) {
    return cv::dnn::experimental_dnn_34_v7::readNetFromTensorflow(model, config);
  });
  mod.method("readNetFromTensorflow",
             [](const char *bufferModel, size_t lenModel) {
               return cv::dnn::experimental_dnn_34_v7::readNetFromTensorflow(
  ...
  mod.method("readNetFromTorch", [](const cv::String &model) {
    return cv::dnn::experimental_dnn_34_v7::readNetFromTorch(model);
  });
  mod.method("readNetFromTorch", [](const cv::String &model, bool isBinary) {
    return cv::dnn::experimental_dnn_34_v7::readNetFromTorch(model, isBinary);
  });
  mod.method("readNet", [](const cv::String &model) {
    return cv::dnn::experimental_dnn_34_v7::readNet(model);
  });
  mod.method("readNet", [](const cv::String &model, const cv::String &config) {
    return cv::dnn::experimental_dnn_34_v7::readNet(model, config);
  });
  mod.method("readNet", [](const cv::String &model, const cv::String &config,
                           const cv::String &framework) {
    return cv::dnn::experimental_dnn_34_v7::readNet(model, config, framework);
  });
  mod.method("readTorchBlob", [](const cv::String &filename) {
    return cv::dnn::experimental_dnn_34_v7::readTorchBlob(filename);
  });
  mod.method("readTorchBlob", [](const cv::String &filename, bool isBinary) {
    return cv::dnn::experimental_dnn_34_v7::readTorchBlob(filename, isBinary);
  });
  mod.method("readNetFromModelOptimizer", [](const cv::String &xml,
                                             const cv::String &bin) {
    return cv::dnn::experimental_dnn_34_v7::readNetFromModelOptimizer(xml, bin);
  });
  mod.method("blobFromImage", [](const cv::Mat &image) {
    return cv::dnn::experimental_dnn_34_v7::blobFromImage(cv::InputArray(image));
  });
  ...
  mod.method("blobFromImage",
             [](const cv::Mat &image, double scalefactor, const cv::Size &size,
               ...
               return cv::dnn::experimental_dnn_34_v7::blobFromImage(
  ...
  mod.method("blobFromImages", [](const std::vector<cv::Mat> &images) {
    return cv::dnn::experimental_dnn_34_v7::blobFromImages(
  ...
  mod.method("imagesFromBlob",
             [](const cv::Mat &blob_, const std::vector<cv::Mat> &images_) {
               return cv::dnn::experimental_dnn_34_v7::imagesFromBlob(
                   blob_, cv::OutputArrayOfArrays(images_));
             });
  mod.method("shrinkCaffeModel",
             [](const cv::String &src, const cv::String &dst) {
               return cv::dnn::experimental_dnn_34_v7::shrinkCaffeModel(src, dst);
             });
  mod.method("shrinkCaffeModel",
             [](const cv::String &src, const cv::String &dst,
                const std::vector<String> &layersTypes) {
               return cv::dnn::experimental_dnn_34_v7::shrinkCaffeModel(
                   src, dst, layersTypes);
             });
  mod.method("NMSBoxes",
             [](const std::vector<Rect> &bboxes,
               ...
               return cv::dnn::experimental_dnn_34_v7::NMSBoxes(
  ...
  mod.add_type<cv::dnn::experimental_dnn_34_v7::LayerFactory>("LayerFactory")
      /*.method("registerLayer",
              [](cv::dnn::experimental_dnn_34_v7::LayerFactory &instance,
                 const cv::String &type,
                 cv::dnn::experimental_dnn_34_v7::LayerFactory::Constructor
                     constructor) {
